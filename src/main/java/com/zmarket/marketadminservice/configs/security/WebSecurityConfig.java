package com.zmarket.marketadminservice.configs.security;

import com.zmarket.marketadminservice.modules.security.JwtAccessDeniedHandler;
import com.zmarket.marketadminservice.modules.security.JwtAuthenticationEntryPoint;
import com.zmarket.marketadminservice.modules.security.UserModelDetailsService;
import com.zmarket.marketadminservice.modules.security.jwt.JWTConfigurer;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                ...
                .antMatchers("/admin/**").hasAuthority("ROLE_MARKET_SELLER")
