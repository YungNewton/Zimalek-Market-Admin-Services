...
import com.zmarket.marketadminservice.dtos.ApiFieldError;
import com.zmarket.marketadminservice.dtos.ApiResponse;
...
public class GenericControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNoContentException(RuntimeException ex, WebRequest request) {
        return handleExceptionInternal(ex , new ApiResponse(true,  ex.getMessage()), new HttpHeaders(), HttpStatus.NO_CONTENT, request);
    }
